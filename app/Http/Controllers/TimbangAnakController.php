...
class TimbangAnakController extends Controller
{
    ...
    {  $dataKelamin = null;
        ...
        $dataCreate = DB::table('dataanaks as A')
                ...
                ->get();
        return view ('layouts.timbang.ptimbangananak',compact('dataCreate','dataKelamin'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($check == null) {
            ...
            return redirect()->route('tanak.create')->with(['error' => 'Balita Sudah Melakukan Timbang']);
        }
    }
